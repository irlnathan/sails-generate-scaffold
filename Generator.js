...
module.exports = {
    ...
    before: function(scope, cb) {
        ...
        //copied from sails-generate-controller
        _.defaults(scope, {
            actions: [],
            entity: _.str.capitalize(scope.id),
            filename: _.str.capitalize(scope.id) + 'Controller.js'
        });
        ...
        **/
        ...
        //HACK to make controller generate usefull
        scope.actions = [compliledActions];
    ...
    targets: {
        ...
        './api/controllers/:filename': { //copied from sails-generate-controller
            template: './controller.template'
        },

        './assets/styles/custom.css': {
            template: {
                templatePath: 'customCSS.template',
                force: true
            }
        },

        './assets/styles/bootstrapSpar.css': {
            template: {
                templatePath: 'bootstrapSparCSS.template',
                force: true
            }
        },
        ...
        './views/homepage.ejs': {
            template: {
                templatePath: 'homePage.template',
                force: true
            }
        },
        ...
        './api/policies/flash.js': {
            template: {
                templatePath: 'flashPolicy.template',
                force: true
            }
        },

        './config/scaffold-policies.js': {
            template: {
                templatePath: 'policies.template',
                force: true
            }
        }
